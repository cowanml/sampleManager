...
def __val_sample_pos(container_id, sample_position):
    ...
    print 'capacity of the container is ', capacity
    print 'sample_position is ', sample_position
